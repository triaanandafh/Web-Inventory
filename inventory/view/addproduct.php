...
// lempar ke view
include 'views/inventory/addProduct.php';
?> -->
...
<html lang="en">
    ...
    <form action="index.php?mod=inventory&act=store" method="POST">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <option>Perabot Rumah Tangga</option>
                            <option>Perawatan Diri</option>
                            <option>Kesehatan</option>
                            <option>Otomotif</option>
                            <option>Peralatan Taman</option>
                            ...
                            <option>Perlengkapan Hewan</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
